...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorColor = 0xFF2BABF4;//修改滑块的颜色
	private int indicatorHeight = 4;//修改滑块的高度
	private int underlineColor = 0xFF2BABF4;//下划线的颜色
	private int underlineHeight = 2;//下划线的高度
	private int tabTextSize = 16;//修改字体的大小
	private int tabBackgroundResId = R.drawable.background_tab;//将里面引用的按下颜色改为透明
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		if (tabTextColor == null) {
			tabTextColor = ColorStateList.valueOf(0xFF31B4F7);
		}
